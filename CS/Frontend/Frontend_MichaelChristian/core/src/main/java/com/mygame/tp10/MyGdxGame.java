...
public class MyGdxGame extends ApplicationAdapter {
    ...
    private void drawDebugUI() {
        font.draw(batch, "Current State: " + player.getCurrentStateName(), 10, Gdx.graphics.getHeight() - 10);
        font.draw(batch, "Current Strategy: " + player.getCurrentStrategyName(), 10, Gdx.graphics.getHeight() - 30);
        font.draw(batch, "Position: " + player.position, 10, Gdx.graphics.getHeight() - 50);
        ...
        font.draw(batch, "1: Aggressive Strategy", 10, 40);
        font.draw(batch, "2: Defensive Strategy", 10, 20);
